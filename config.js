...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "IK~Bd1nTLqZ#ETBrl_P6TdDtGjI9BsXlc6xC87es7IdLyOEZCqyOfRo",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "40770811929",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || getConfig("cosmin") || "𝐸𝑅𝐹𝒜𝒩 𝒜𝐻𝑀𝒜𝒟",           // Owner's name
